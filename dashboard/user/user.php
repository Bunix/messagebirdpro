...
<!--[if gt IE 8]><!--> <html class="" lang="en"> <!--<![endif]-->
    <head>
        <script>
            var analyticsVars = {
                'page': '/app/en/user/index',
                'title': 'Dashboard - MessageBird'
            };
        </script>
        <meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Dashboard - MessageBird</title><meta name="description" content="MessageBird is the complete solution for companies to use text messages for marketing, notification and communication purposes. Integrate our services in your own software or use our website." /><meta name="csrf-param" content="_csrf">
    <meta name="csrf-token" content="dEd0mxOTJ3aEFp9ZIyN9_mNyxeFs2RCYimQsBQFTVlILh28p4HLkbDVd6aMjabTFFUYIEAB8fllBmtKQM1H5OA==">
...
<!-- Favicon -->
        ...
        <link rel="apple-touch-icon-precomposed" sizes="152x152" href="https://dash.cdn.messagebird.com/assets/images/favicons/apple-touch-icon-152x152.png" />
        <link rel="icon" type="image/png" href="https://dash.cdn.messagebird.com/assets/images/favicons/favicon-32x32.png" sizes="32x32" />
        <link rel="icon" type="image/png" href="https://dash.cdn.messagebird.com/assets/images/favicons/favicon-16x16.png" sizes="16x16" /><link rel="icon" type="image/x-icon" href="https://dash.cdn.messagebird.com/assets/images/favicons/favicon.ico" /><meta name="application-name" content="&nbsp;"/>
        <meta name="msapplication-TileColor" content="#FFFFFF" />
        <meta name="msapplication-TileImage" content="https://dash.cdn.messagebird.com/assets/images/favicons/mstile-144x144.png" />
...
<link href="https://dash.cdn.messagebird.com/assets/css/all-3f93e45308f9ee9ad5bff0d4926e6017539af3b7.css" rel="stylesheet">
...
<![endif]-->
    ...
    <body class="en">
        <div class="body-background kendrick-lamar">

            <div class="body-veil js-body-veil">
                <div class="body-veil-close js-body-veil-close">
                    <i class="fa fa-times"></i>
                </div>
            </div>

            <!-- Inserted right after the opening body tag -->
    ...
    <nav id="navbar-top" class="navbar navbar-default">
        <div class="main-container">
            ...
            <a href="#" class="header-menu-button js-header-menu-button">
                <i class="fa fa-bars"></i>
            </a>

            <div class="header-logo-container visible-xs-inline-block">
                <a class="logo-link" href="/en/"><img class="logo logo-mobile visible-xs" src="/assets/images/logo/logo-icon.svg" height="28" alt="logo"></a>            </div>

            
<div class="header-greeting">
    <span>Good morning, etechnohubshop@gmail.com!</span>
</div>
            <ul class="nav navbar-nav navbar-right">
                                        <li class="menu-no-mobile">
        <a href="/en/setup-guide" target="_blank" class="support">
            <span class="js-onboarding-popover sg-link" data-toggle="popover" data-placement="bottom" data-content="You can always visit the Setup Guide by clicking here.">Setup Guide<span class="sg-progress-pill"></span></span>
        </a>
    </li>
                    
<li class="dropdown">
    <a class="user header-main-link dropdown-toggle account-menu" href="#" data-toggle="dropdown" aria-expanded="false">
        <span class="account-label">Workspace:</span> <span class="hidden-xs">Unnamed Business</span><i class="fa fa-chevron-down"></i>
    </a>
    <div class="dropdown-menu mini">
        <ul class="animated zoomIn" role="menu" aria-labelledby="dropdownMenu4">

            <li role="presentation" class="profile-dropdown-header">
                <span class="profile-dropdown-header-name">Unnamed Business</span>
                <span class="profile-dropdown-header-role">Current Worskpace</span>
            </li>

            <li><hr class="dropdown-divider" /></li>

            <li role="presentation"><a role="menuitem" tabindex="-1" class="skip-pjax" href="/en/settings/details">Settings</a></li>

                            <li role="presentation"><a role="menuitem" tabindex="-1" class="skip-pjax" href="/en/financial/list">Financial</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" class="skip-pjax" href="/en/settings/users">Users</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" class="skip-pjax" href="/en/settings/subaccounts">Subaccounts</a></li>
            
            <li><hr class="dropdown-divider" /></li>

            
                <li role="presentation"><a role="menuitem" tabindex="-1" class="skip-pjax" href="/en/account/workspaces">Switch Workspace</a></li>
...
<li class="dropdown">
    <a class="user header-main-link dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
        <div class="user-avatar" style="background-image: url('/gravatar.php?hash=5fcaec18c40cdf745651f8aa9dd9cf4f');"></div>
    ...
    <div class="dropdown-menu mini">
        <ul class="animated zoomIn" role="menu" aria-labelledby="dropdownMenu4">
            ...
            <li role="presentation" class="profile-dropdown-header">
                <span class="profile-dropdown-header-name">etechnohubshop@gmail.com</span>
                <span class="profile-dropdown-header-role">Your account</span>
            </li>

            <li><hr class="dropdown-divider" /></li>

            <li role="presentation"><a role="menuitem" tabindex="-1" class="skip-pjax" href="/en/account/settings">Settings</a></li>
            <li role="presentation"><a role="menuitem" tabindex="-1" class="skip-pjax" href="/en/logout" class="skip-pjax">Log out</a></li>
        </ul>
    </div>
</li>            </ul>
        </div>
            ...
            <div id="wrapper-main" class="main-container clearfix">
                
<nav class="main-side-menu side-menu js-side-menu">
    <a class="logo-link" href="/en/"><img class="logo" src="/assets/images/logo/logo.svg" height="32" alt="logo"></a>
    
<div class="welcome-user">
    <span class="welcome">

        
            <div class="credit-type">Test Credits</div>
            <div id="user-balance" class="credit-amount ">9</div>
            <p class="main-side-menu-note">Note: Test-credits can only be used to send to your own number.</p>
            <a class="credit-buy-more" href="/en/financial/buy-credits">Buy credits</a>
    ...
    <ul class='nav nav-stacked kv-sidenav'>
                    <li class="dashboard  active">
                                            <a href="/en/user/index"><div class="icon-con"><figure class="mb-icon inline icon-18"><svg width="18pt" height="18pt" viewBox="0 0 2160 2160" xmlns="http://www.w3.org/2000/svg"><g stroke-width="180" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><path d="M488.4 1863c-174-165.3-278.4-400.2-278.4-661.2C210 697.2 601.5 297 1080 297s870 408.9 870 904.8c0 252.3-95.7 478.5-261 643.8M1080 297v182.7M1715.1 584.1l-121.8 130.5M610.2 1732.5L488.4 1863M479.7 584.1l121.8 130.5M1567.2 1715.1l121.8 130.5M210 1201.438h174M1776 1201.438h174" stroke="#4B5669"/><path d="M1080 1114.8c48.024 0 87 38.976 87 87s-38.976 87-87 87-87-38.976-87-87 38.976-87 87-87zM1080 1201.8L810.3 923.4" stroke="#9AA8BD"/></g></svg></figure></div>Dashboard</a>
                                    </li>
                            <li class="statistics  ">
                                            <a href="#" class="kv-toggle">
                            <span class="opened" style="display:none"></span>
                            <span class="closed"></span>
                            <div class="icon-con"><figure class="mb-icon inline icon-18"><svg width="18pt" height="18pt" viewBox="0 0 2160 2160" xmlns="http://www.w3.org/2000/svg"><g stroke-width="180" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><path stroke="#9AA8BD" d="M1936.35 1859H215V302"/><path stroke="#4B5669" d="M500.45 1590.85h259.5v-519h-259.5zM1105.95 1590.85h259.5V803.7h-259.5zM1685.5 1582.2H1945v-1211h-259.5z"/></g></svg></figure></div>Statistics                        </a>
                        <ul class='nav nav-stacked'>
                                                                <li>
                                        <a class="" href="/en/statistics/mt">SMS</a>
                                    </li>
                                                                    <li>
                                        <a class="" href="/en/statistics/premium">Premium SMS</a>
                                    </li>
                                                        </ul>
                                    </li>
                            <li class="contacts  ">
                                            <a href="/en/addressbook"><div class="icon-con"><figure class="mb-icon inline icon-18"><svg width="18pt" height="18pt" viewBox="0 0 2160 2160" xmlns="http://www.w3.org/2000/svg"><g stroke-width="180" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><path d="M1071.35 1149.2c-121.1 0-216.25-95.15-216.25-216.25v-86.5c0-121.1 95.15-216.25 216.25-216.25s216.25 95.15 216.25 216.25v86.5c0 121.1-95.15 216.25-216.25 216.25zM552.35 1772c0-190.3 155.7-354.65 354.65-354.65h337.35c190.3 0 354.65 155.7 354.65 354.65" stroke="#9AA8BD"/><path d="M1080 215c477.74 0 865 387.26 865 865s-387.26 865-865 865-865-387.26-865-865 387.26-865 865-865z" stroke="#4B5669"/></g></svg></figure></div>Contacts</a>
                                    </li>
                            <li class="numbers  ">
                                            <a href="/en/numbers"><div class="icon-con"><figure class="mb-icon inline icon-18"><svg width="18pt" height="18pt" viewBox="0 0 2160 2160" xmlns="http://www.w3.org/2000/svg"><g stroke-width="180" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><path d="M1577 1450.556l-497 497-497-497C448.889 1316.444 370 1135 370 937.778 370 535.444 685.556 212 1080 212s710 323.444 710 725.778c0 197.222-78.889 378.666-213 512.778" stroke="#4B5669"/><path d="M993.222 622.222l-142 725.778M1293 606.444L1151 1348M717.111 1110.594h725.778M717.111 834.73h725.778" stroke="#9AA8BD"/></g></svg></figure></div> Numbers</a>
                                    </li>
                            <li class="sms  ">
                                            <a href="#" class="kv-toggle">
                            <span class="opened" style="display:none"></span>
                            <span class="closed"></span>
                            <div class="icon-con"><figure class="mb-icon inline icon-18"><svg width="18pt" height="18pt" viewBox="0 0 2160 2160" xmlns="http://www.w3.org/2000/svg"><g stroke-width="180" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><path d="M561 768.74h1038" stroke="#9AA8BD"/><path d="M561 1210.25h1038" stroke="#9AA8BD" stroke-dasharray="6,3"/><path stroke="#4B5669" d="M1218.4 1694.65L1054.05 1859 889.7 1711.95H215V302h1730v1409.95h-432.5"/></g></svg></figure></div>SMS                        </a>
                        <ul class='nav nav-stacked'>
                                                                <li>
                                        <a class="" href="/en/messages/list">SMS Overview</a>
                                    </li>
                                                                    <li>
                                        <a class="" href="/en/messages/send-sms">Send Campaign</a>
                                    </li>
                                                                    <li>
                                        <a class="" href="/en/messages/quick-send">Quick Send</a>
                                    </li>
                                                        </ul>
                                    </li>
                            <li class="voice  ">
                            ...
                            <span class="opened" style="display:none"></span>
                            <span class="closed"></span>
                            <div class="icon-con"><figure class="mb-icon inline icon-18"><svg width="18pt" height="18pt" viewBox="0 0 2160 2160" xmlns="http://www.w3.org/2000/svg"><g stroke-width="180" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><path d="M447.272 454.927c34.826-34.8 156.718 17.4 261.197 130.498C821.654 681.123 873.894 794.22 839.067 837.72M1342.3 1332.944c34.812-34.826 156.651 17.413 261.085 130.599 104.434 104.479 165.354 226.37 130.543 261.197M1341.3 1332.08l-104.256 104.287c-34.752 34.762-104.256 34.762-139.007 0l-364.894-356.313c-43.44-34.762-43.44-104.286 0-139.048l104.255-104.287" stroke="#4B5669"/><path d="M1739.242 1719.01l-117.642 109.3c-26.112 26.076-130.56 121.689-304.639 121.689s-287.23-95.613-313.342-112.997c-130.56-112.997-261.12-234.686-400.383-365.067-130.56-130.381-174.079-173.842-287.23-295.53-28.766-31.567-113.152-147.766-104.448-312.915 8.704-165.15 78.28-261.37 122.743-304.496l118.736-108.379" stroke="#4B5669"/><path d="M1168.1 767.64c121.1 0 216.249 95.443 216.249 208.24M1186.12 480.31c269.9 0 487.561 217.067 487.561 477.548M1212.15 211C1620.69 211 1951 541.165 1951 940.839" stroke="#9AA8BD"/></g></svg></figure></div>Voice                        </a>
                        <ul class='nav nav-stacked'>
                                                                <li>
                                        <a class="" href="/en/voice/list">Messaging Overview</a>
                                    </li>
                                                                    <li>
                                        <a class="" href="/en/messages/send-voice">Send Voice Message</a>
                                    </li>
                                                        </ul>
                                    </li>
                            <li class="chat  ">
                                            <a href="/en/chat-api/channels"><div class="icon-con"><figure class="mb-icon inline icon-18"><svg width="18pt" height="18pt" viewBox="0 0 2160 2160" xmlns="http://www.w3.org/2000/svg"><g stroke-width="200" fill="none" fill-rule="evenodd"><g stroke-linecap="round" stroke="#4B5669" stroke-linejoin="round"><path d="M1191.797 1715.876l-166.02 173.805-166.11-171.27h-639.64V270.036h1719.946v1448.375h-452.617"/><path d="M1487.383 1718.375H1940V270H220.055v1448.375h633.664"/></g><g transform="translate(599 940)" stroke="#9AA8BD"><circle cx="481.5" cy="53.5" r="53.5"/><circle cx="908.5" cy="53.5" r="53.5"/><circle cx="53.5" cy="53.5" r="53.5"/></g></g></svg></figure></div>Chat</a>
                                    </li>
                            <li class="applications  ">
                                            <a href="#" class="kv-toggle">
                            <span class="opened" style="display:none"></span>
                            <span class="closed"></span>
                            <div class="icon-con"><figure class="mb-icon inline icon-18"><svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 24"><path class="st1" d="M5.9 9.1l6.7-3.8" style="fill: none; stroke: #9aa8bd; stroke-linecap: round; stroke-linejoin: round; stroke-miterlimit: 10; stroke-width: 2;"/><path class="st0" d="M21 17.5l-6.9 3.8L11 23 1 17.5v-11l4.8-2.6L11 1l9.9 5.5z" style="fill: none; stroke: #4b5669; stroke-linecap: round; stroke-linejoin: round; stroke-miterlimit: 10; stroke-width: 2;"/><path class="st0" d="M20.9 6.5l-6.8 3.8L11 12 1 6.5l4.8-2.6L11 1z" style="fill: none; stroke: #4b5669; stroke-linecap: round; stroke-linejoin: round; stroke-miterlimit: 10; stroke-width: 2;"/><path class="st1" d="M11 15.8V23" style="fill: none; stroke: #9aa8bd; stroke-linecap: round; stroke-linejoin: round; stroke-miterlimit: 10; stroke-width: 2;"/><path class="st0" d="M20.9 6.5l.1 11-6.9 3.8L11 23 1 17.5m0-11v11" style="fill: none; stroke: #4b5669; stroke-linecap: round; stroke-linejoin: round; stroke-miterlimit: 10; stroke-width: 2;"/></svg></figure></div> Applications                        </a>
                        <ul class='nav nav-stacked'>
                                                                <li>
                                        <a class="" href="/en/messages/import">Bulk Messaging</a>
                                    </li>
                                                                    <li>
                                        <a class="" href="/en/mail-to-sms">Email to SMS</a>
                                    </li>
                                                                    <li>
                                        <a class="" href="/en/keywords">Keywords</a>
                                    </li>
                                                                    <li>
                                        <a class="" href="/en/templates">Templates</a>
                                    </li>
                                                        </ul>
                                    </li>
                            <li class="developers  ">
                                            <a href="/en/developers/settings"><div class="icon-con"><figure class="mb-icon inline icon-18"><svg width="18pt" height="18pt" viewBox="0 0 2160 2160" xmlns="http://www.w3.org/2000/svg"><g stroke-width="180" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><path d="M1945 1815.75V302H215v363.3-43.25 1193.7c0 25.95 17.3 43.25 43.25 43.25H1893.1c34.6 0 51.9-17.3 51.9-43.25z" stroke="#4B5669"/><path d="M1080 1399.69h544.95M535.05 985.35l268.15 276.8-268.15 276.8" stroke="#9AA8BD"/><path d="M1581.7 664.187H215" stroke="#4B5669"/></g></svg></figure></div> Developers</a>
                                    </li>
                </ul>
</nav>

                                <section class="main-content js-main-content page-content " id="pjax-main-container">
        ...
        <div class="chart-options">
            <form action="/en/statistics/graphic/mt" rel="user-index-sms">
                <button class="btn active" rel="statistics-year">Per month</button>                                <button class="btn" rel="statistics-month">Per day</button>                <button class="btn" rel="statistics-day">Per hour</button>                <div class="pull-right">
                                        <select id="start_date_day" class="select2 select2-wide select-datetime" name="start_date_day">
...
</select>                    <select id="start_date_month" class="select2 select2-medium select-datetime" name="start_date_month">
...
</select>                    <select id="start_date_year" class="select2 select2-narrow select-datetime" name="start_date_year">
...
<option value="2017" selected>2017</option>
        ...
        <div class="chart ct-chart" id="user-index-sms"></div>
    </div>
</section>
<p>&nbsp;</p><p>&nbsp;</p>
</div>
...
<footer class="main">
        ...
        <li class="hidden-sm hidden-xs">
            <a class="js-open-locale-modal" data-toggle="modal" data-target="#select-language" href="#">
                Change region            </a>
        </li>
        <li>
            <a href="https://www.messagebird.com/en/terms">Conditions</a>        </li>
        <li>
            <a href="https://www.messagebird.com/en/privacy">Privacy</a>        </li>
        <li>
            <a href="https://developers.messagebird.com/" class="skip-pjax">Documentation</a>
        </li>
                    <li>
                <a href="http://support.messagebird.com/hc/en-us/" target="_blank" class="support">Help &amp; Support</a>
            </li>
                <li id="menu-contact">
                            <a href="https://www.messagebird.com/en/contact">Contact</a>                    </li>
...
<div class="locale-modal modal fade" id="select-language" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="close">
        <a href="#" data-dismiss="modal">
            <figure class="mb-icon icon-24">
                <svg width="1920px" height="1920px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg"><g stroke="#FFF" stroke-width="200" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><path d="M101 1819L1819 101M1819 1819L101 101"/></g></svg>            </figure>
        </a>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-body clearfix">
                ...
                <div class="locale-modal-lists-container clearfix">
                    ...
                    <div class="locale-modal-col col-md-offset-1 col-md-6" style="height: 265px;">
                        <ul class="locale-modal-menu clearfix js-locale-modal-menu">
                                    ...
                                    <a href="/nl/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span>
                                            <img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/NL_netherlands.png" />
                                            Nederland                                        </span>
                                    </a>
                                </li>
                                                            <li class="locale-modal-menu-item">
                                    <a href="/en-gb/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span>
                                            <img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/UK_unitedKingdom.png" />
                                            United Kingdom                                        </span>
                                    </a>
                                </li>
                                                            <li class="locale-modal-menu-item">
                                    <a href="/en-us/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span>
                                            <img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/US_unitedStates.png" />
                                            United States                                        </span>
                                    </a>
                                </li>
                                                            <li class="locale-modal-menu-item">
                                    <a href="/de-de/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span>
                                            <img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/DE_germany.png" />
                                            Deutschland                                        </span>
                                    </a>
                                </li>
                                                            <li class="locale-modal-menu-item">
                                    <a href="/es-es/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span>
                                            <img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/ES_spain.png" />
                                            España                                        </span>
                                    </a>
                                </li>
                                                            <li class="locale-modal-menu-item">
                                    <a href="/fr-fr/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span>
                                            <img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/FR_france.png" />
                                            France                                        </span>
                                    </a>
                                </li>
                                                            <li class="locale-modal-menu-item">
                                    <a href="/nl-be/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span>
                                            <img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/BE_belgium.png" />
                                            Belgique / België                                        </span>
                                    </a>
                                </li>
                                                            <li class="locale-modal-menu-item">
                                    <a href="/en-ca/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span>
                                            <img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/CA_canada.png" />
                                            Canada                                        </span>
                                    </a>
                                </li>
                                                            <li class="locale-modal-menu-item">
                                    <a href="/en-au/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span>
                                            <img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/AU_australia.png" />
                                            Australia                                        </span>
                                    </a>
                                </li>
                                                            <li class="locale-modal-menu-item">
                                    <a href="/en-nz/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span>
                                            <img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/ZN_newZealand.png" />
                                            New Zealand                                        </span>
                                    </a>
                                </li>
                                                    </ul>
                        ...
                        <select onchange="if (this.value) window.location.href=this.value">
                            <option value="" disabled selected>Choose your country</option>
                                                            <optgroup label="Africa">
                                                                                <option value="/en-gh/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Ghana                                            </option>
                                                                                    <option value="/en-ke/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Kenya                                            </option>
                                                                                    <option value="/en-ng/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Nigeria                                            </option>
                                                                                    <option value="/en-ug/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Uganda                                            </option>
                                                                                    <option value="/en-zw/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Zimbabwe                                            </option>
                                                                        </optgroup>
                                                          <optgroup label="Asia">
                                                                                <option value="/en-hk/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Hong Kong                                            </option>
                                                                                    <option value="/en-sg/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Singapore                                            </option>
                                                                        </optgroup>
                                                          <optgroup label="Europe">
                                                                                <option value="/fr-be/user/index?loginsuccess=1&force=1" data-name-locale="Français">
                                                Belgique                                            </option>
                                                                                    <option value="/nl-be/user/index?loginsuccess=1&force=1" data-name-locale="Vlaams">
                                                België                                            </option>
                                                                                    <option value="/de-de/user/index?loginsuccess=1&force=1" data-name-locale="Deutsch">
                                                Deutschland                                            </option>
                                                                                    <option value="/es-es/user/index?loginsuccess=1&force=1" data-name-locale="Español">
                                                España                                            </option>
                                                                                    <option value="/fr-fr/user/index?loginsuccess=1&force=1" data-name-locale="Français">
                                                France                                            </option>
                                                                                    <option value="/en-gi/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Gibraltar                                            </option>
                                                                                    <option value="/en-gg/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Guernsey                                            </option>
                                                                                    <option value="/en-ie/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Ireland                                            </option>
                                                                                    <option value="/en-im/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Isle of Man                                            </option>
                                                                                    <option value="/en-je/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Jersey                                            </option>
                                                                                    <option value="/nl/user/index?loginsuccess=1&force=1" data-name-locale="Nederlands">
                                                Nederland                                            </option>
                                                                                    <option value="/en-gb/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                United Kingdom                                            </option>
                                                                        </optgroup>
                                                          <optgroup label="North America">
                                                                                <option value="/en-bs/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Bahamas                                            </option>
                                                                                    <option value="/en-bz/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Belize                                            </option>
                                                                                    <option value="/en-bm/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Bermuda                                            </option>
                                                                                    <option value="/en-vg/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                British Virgin Islands                                            </option>
                                                                                    <option value="/en-ca/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Canada                                            </option>
                                                                                    <option value="/en-ky/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Cayman Islands                                            </option>
                                                                                    <option value="/en-gd/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Grenada                                            </option>
                                                                                    <option value="/en-jm/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Jamaica                                            </option>
                                                                                    <option value="/en-pr/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Puerto Rico                                            </option>
                                                                                    <option value="/en-tt/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Trinidad & Tobago                                            </option>
                                                                                    <option value="/en-us/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                United States                                            </option>
                                                                        </optgroup>
                                                          <optgroup label="Oceania">
                                                                                <option value="/en-au/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Australia                                            </option>
                                                                                    <option value="/en-gu/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Guam                                            </option>
                                                                                    <option value="/en-nz/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                New Zealand                                            </option>
                                                                        </optgroup>
                                                          <optgroup label="South America">
                                                                                <option value="/en-gy/user/index?loginsuccess=1&force=1" data-name-locale="English">
                                                Guyana                                            </option>
                                                                        </optgroup>
                                                    <optgroup label="Other">
                              <option value="/en/user/index?loginsuccess=1&force=1">
                                  Rest of world
                              </option>
                          </optgroup>
                        </select>
                        ...
                        <div class="locale-modal-col-footer">
                            ...
                            <div class="clearfix">
                                <div class="locale-modal-menu-item locale-modal-center">
                                    <a href="/en/user/index?loginsuccess=1&force=1" class="skip-pjax">
                                        <span><img class="locale-modal-menu-item-flag" src="https://dash.cdn.messagebird.com/assets/assets-images/flags/countryname/UK_unitedKingdom.png" />English</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="locale-modal-footer">
                    <p>If you have any questions, suggestions or complaints concerning our localisation efforts, <a href="/en/contact">you can always contact us</a>. We’d love to hear from you!</p>
                </div>
...
<!-- env: prod-dc1-web-100  -->

            <div class="modal" id="show-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <script src="https://dash.cdn.messagebird.com/assets/js/all-3f93e45308f9ee9ad5bff0d4926e6017539af3b7.js"></script>
<script src="https://dash.cdn.messagebird.com/assets/35251526/yii2-dynamic-form.min.js"></script>
<script type="text/javascript">jQuery(document).ready(function () {
$('.chart-options form').each(function() { processStatisticsChange(this); })
